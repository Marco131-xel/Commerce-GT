...
-- Usuario 1 (muy activo) - 5 carritos
(1, 'ACTIVO'), (1, 'ACTIVO'), (1, 'ACTIVO'), (1, 'ACTIVO'), (1, 'ACTIVO'),
-- Usuario 2 (muy activo) - 4 carritos
(2, 'ACTIVO'), (2, 'ACTIVO'), (2, 'ACTIVO'), (2, 'ACTIVO'),
-- Usuario 3 (muy activo) - 4 carritos
(3, 'ACTIVO'), (3, 'ACTIVO'), (3, 'ACTIVO'), (3, 'ACTIVO'),
-- Usuario 4 (activo) - 3 carritos
(4, 'ACTIVO'), (4, 'ACTIVO'), (4, 'ACTIVO'),
-- Usuario 5 (activo) - 3 carritos
(5, 'ACTIVO'), (5, 'ACTIVO'), (5, 'ACTIVO'),
-- Usuario 6 (activo) - 2 carritos
(6, 'ACTIVO'), (6, 'ACTIVO'),
-- Usuario 7 (poco activo) - 1 carrito
(7, 'ACTIVO'),
-- Usuario 8 (poco activo) - 1 carrito
(8, 'ACTIVO'),
-- Usuario 9 (poco activo) - 1 carrito
(9, 'ACTIVO'),
-- Usuario 10 (poco activo) - 1 carrito
(10, 'ACTIVO');

-- Insertar detalles de carrito con distribución que refleje el comportamiento de compra
INSERT INTO carrito_detalle (id_carrito, id_producto, cantidad) VALUES 
-- Carritos del Usuario 1 (comprador frecuente, muchos productos)
(1, 5, 2), (1, 12, 1), (1, 25, 3), (1, 30, 1),
(2, 8, 1), (2, 15, 2), (2, 42, 1),
(3, 3, 1), (3, 18, 2), (3, 22, 1), (3, 47, 1),
(4, 7, 2), (4, 14, 1), (4, 29, 1),
(5, 9, 1), (5, 21, 2), (5, 35, 1),

-- Carritos del Usuario 2 (comprador frecuente)
(6, 11, 1), (6, 26, 2), (6, 38, 1),
(7, 4, 1), (7, 17, 1), (7, 33, 2),
(8, 13, 1), (8, 28, 1), (8, 44, 1),
(9, 6, 2), (9, 19, 1), (9, 40, 1),

-- Carritos del Usuario 3 (comprador frecuente)
(10, 2, 1), (10, 16, 1), (10, 31, 2),
(11, 20, 1), (11, 27, 1), (11, 45, 1),
(12, 1, 1), (12, 23, 1), (12, 39, 1),
(13, 10, 2), (13, 24, 1), (13, 50, 1),

-- Carritos del Usuario 4
(14, 32, 1), (14, 46, 2), (14, 55, 1),
(15, 34, 1), (15, 48, 1), (15, 60, 1),
(16, 36, 2), (16, 52, 1),

-- Carritos del Usuario 5
(17, 37, 1), (17, 54, 1), (17, 65, 1),
(18, 41, 1), (18, 58, 2),
(19, 43, 1), (19, 59, 1),

-- Carritos del Usuario 6
(20, 49, 1), (20, 63, 1), (20, 70, 1),
(21, 51, 1), (21, 67, 1),

-- Carritos de usuarios poco activos (solo 1-2 productos)
(22, 56, 1),
(23, 61, 1),
(24, 64, 1),
(25, 68, 1);

-- Insertar pedidos con distribución desigual (más pedidos para usuarios activos)
-- 35 pedidos total: 20 EN_CURSO, 15 ENTREGADO
INSERT INTO pedidos (id_usuario, id_tarjeta, fecha_pedido, fecha_entrega_estimada, estado, total) VALUES 
-- Usuario 1 (top comprador) - 7 pedidos
(1, 1, '2024-01-05 10:30:00', '2024-01-10', 'ENTREGADO', 285.00),
(1, 1, '2024-01-12 14:20:00', '2024-01-17', 'ENTREGADO', 420.50),
(1, 1, '2024-01-18 09:15:00', '2024-01-23', 'ENTREGADO', 195.75),
(1, 1, '2024-01-25 16:45:00', '2024-01-30', 'EN_CURSO', 320.00),
(1, 1, '2024-02-01 11:30:00', '2024-02-06', 'EN_CURSO', 550.25),
(1, 1, '2024-02-08 13:20:00', '2024-02-13', 'EN_CURSO', 175.80),
(1, 1, '2024-02-15 15:10:00', '2024-02-20', 'EN_CURSO', 280.00),

-- Usuario 2 (top comprador) - 6 pedidos
(2, 2, '2024-01-07 10:50:00', '2024-01-12', 'ENTREGADO', 520.40),
(2, 2, '2024-01-14 12:25:00', '2024-01-19', 'ENTREGADO', 195.00),
(2, 2, '2024-01-21 14:35:00', '2024-01-26', 'ENTREGADO', 410.75),
(2, 2, '2024-01-28 09:40:00', '2024-02-02', 'EN_CURSO', 225.60),
(2, 2, '2024-02-04 16:15:00', '2024-02-09', 'EN_CURSO', 380.90),
(2, 2, '2024-02-11 11:20:00', '2024-02-16', 'EN_CURSO', 320.30),

-- Usuario 3 (top comprador) - 5 pedidos
(3, 3, '2024-01-09 13:45:00', '2024-01-14', 'ENTREGADO', 275.45),
(3, 3, '2024-01-16 15:30:00', '2024-01-21', 'ENTREGADO', 490.20),
(3, 3, '2024-01-23 10:00:00', '2024-01-28', 'EN_CURSO', 135.75),
(3, 3, '2024-01-30 14:30:00', '2024-02-04', 'EN_CURSO', 280.00),
(3, 3, '2024-02-06 09:45:00', '2024-02-11', 'EN_CURSO', 195.25),

-- Usuario 4 (comprador medio) - 4 pedidos
(4, 4, '2024-01-11 16:20:00', '2024-01-16', 'ENTREGADO', 320.80),
(4, 4, '2024-01-18 11:15:00', '2024-01-23', 'ENTREGADO', 145.60),
(4, 4, '2024-01-25 13:40:00', '2024-01-30', 'EN_CURSO', 280.90),
(4, 4, '2024-02-01 15:25:00', '2024-02-06', 'EN_CURSO', 220.30),

-- Usuario 5 (comprador medio) - 4 pedidos
(5, 5, '2024-01-13 10:50:00', '2024-01-18', 'ENTREGADO', 420.30),
(5, 5, '2024-01-20 12:35:00', '2024-01-25', 'ENTREGADO', 195.45),
(5, 5, '2024-01-27 14:20:00', '2024-02-01', 'EN_CURSO', 160.20),
(5, 5, '2024-02-03 16:10:00', '2024-02-08', 'EN_CURSO', 340.75),

-- Usuario 6 (comprador medio) - 3 pedidos
(6, 6, '2024-01-15 09:30:00', '2024-01-20', 'ENTREGADO', 210.50),
(6, 6, '2024-01-22 14:15:00', '2024-01-27', 'EN_CURSO', 185.00),
(6, 6, '2024-01-29 11:40:00', '2024-02-03', 'EN_CURSO', 275.80),

-- Usuario 7 (comprador ocasional) - 2 pedidos
(7, 7, '2024-01-17 13:20:00', '2024-01-22', 'ENTREGADO', 150.25),
(7, 7, '2024-01-24 15:50:00', '2024-01-29', 'EN_CURSO', 95.00),

-- Usuario 8 (comprador ocasional) - 2 pedidos
(8, 8, '2024-01-19 10:25:00', '2024-01-24', 'ENTREGADO', 180.00),
(8, 8, '2024-01-26 12:45:00', '2024-01-31', 'EN_CURSO', 125.60),

-- Usuario 9 (comprador ocasional) - 1 pedido
(9, 9, '2024-01-21 14:10:00', '2024-01-26', 'ENTREGADO', 310.75),

-- Usuario 10 (comprador ocasional) - 1 pedido
(10, 10, '2024-01-23 16:30:00', '2024-01-28', 'ENTREGADO', 480.90);

-- Insertar detalles de pedido acordes a la distribución
INSERT INTO pedido_detalle (id_pedido, id_producto, cantidad, precio_unitario) VALUES 
-- Pedidos Usuario 1 (muchos detalles por pedido)
(1, 5, 1, 150.00), (1, 12, 2, 35.00), (1, 25, 1, 180.00),
(2, 8, 1, 30.00), (2, 15, 1, 85.00), (2, 22, 1, 70.00), (2, 30, 1, 75.00),
(3, 3, 1, 450.00), (3, 18, 1, 90.00),
(4, 7, 2, 25.00), (4, 14, 1, 40.00), (4, 29, 1, 150.00),
(5, 9, 1, 75.00), (5, 21, 1, 65.00), (5, 35, 1, 35.00), (5, 42, 1, 85.00),
(6, 11, 1, 120.00), (6, 26, 1, 100.00),
(7, 4, 1, 80.00), (7, 17, 1, 280.00),

-- Pedidos Usuario 2
(8, 13, 1, 60.00), (8, 28, 1, 45.00), (8, 35, 1, 35.00),
(9, 6, 1, 35.00), (9, 19, 1, 65.00), (9, 40, 1, 110.00),
...
(14, 27, 1, 55.00), (14, 36, 1, 60.00), (14, 45, 1, 65.00),
...
-- Pedidos Usuario 6
(26, 52, 1, 85.00), (26, 61, 1, 75.00),
(27, 54, 1, 95.00), (27, 65, 1, 110.00),
(28, 57, 1, 120.00), (28, 68, 1, 45.00),

-- Pedidos Usuario 7
(29, 62, 1, 85.00), (29, 69, 1, 65.00),
(30, 64, 1, 95.00),

-- Pedidos Usuario 8
(31, 66, 1, 120.00), (31, 70, 1, 60.00),
(32, 1, 1, 1200.00),

-- Pedidos Usuario 9
(33, 3, 1, 450.00), (33, 8, 1, 30.00),

-- Pedidos Usuario 10
(34, 5, 1, 150.00), (34, 12, 1, 35.00), (34, 25, 1, 180.00);